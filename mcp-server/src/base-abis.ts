// audit 2026-05-22 MC-20 / Tema 8 — chains.ts god-module split (3/3): base-abis.
// Salt ABI sabitleri: ERC-20, ERC-8004 (Identity/Reputation/Validation),
// ERC-8183 (Agentic Jobs), CCTP v2 TokenMessenger. Poker-specific ABI'lar ayrı
// dosya `poker-abis.ts`'te kalır — burada karıştırma yok. Bağımlılık: yok
// (sadece const tanımı, viem'in `as const` çıkarımı yeterli).
